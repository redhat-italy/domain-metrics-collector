...
import com.redhat.it.customers.dmc.core.services.connection.ConnectionService;
...
public class ConnectionServiceImpl implements ConnectionService {
    ...
    /**
     * @throws DMRException
     * @see com.redhat.it.customers.dmc.core.services.connection.ConnectionService#getControllerConnection()
     */
    @Override
    public QueryExecutor getQueryExecutor(String configurationId)
            throws DMRException {
        QueryExecutorImpl queryExecutor = null;

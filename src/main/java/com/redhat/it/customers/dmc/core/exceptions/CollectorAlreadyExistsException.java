 ...
 */
public class CollectorAlreadyExistsException extends ConfigurationException {
    ...
    private final static String message = "Collector \"%s\" already exists.";

    public CollectorAlreadyExistsException(String collectorId) {
     ...
     *            the message
     */
    public CollectorAlreadyExistsException(String collectorId,Throwable cause) {
